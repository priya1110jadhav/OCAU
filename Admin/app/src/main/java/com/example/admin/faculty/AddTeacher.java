...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Computer Science", "Mechanical", "Civil", "IT", "Electronics"};
    ...
    private void checkValidation() {
        ...
        if (name.isEmpty()){
            ...
            pd.setMessage("Ohhh Wait ,Uploading......");
            pd.show();
            insertData();
        }else {
            pd.setMessage("Wait few moment......");
            pd.show();
            uploadImage();
